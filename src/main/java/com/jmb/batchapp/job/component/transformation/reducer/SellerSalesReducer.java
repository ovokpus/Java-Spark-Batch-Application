...
/**
 * Reducer class implements Spark's ReduceFunction and belongs to
 * {@link com.jmb.batchapp.job.implementation.SalesSummaryJob}
 * In doing so it 'reduces' with a sum operation all the sales for a seller,
 * item and particular date.
 *
 * @author JuanMBruno.
 */
public class SellerSalesReducer implements ReduceFunction<Row> {
    ...
    public Row call(Row aggregatedRow, Row currentRow) throws Exception {
        ...
        // Use aggregated row values and add the relevant quantity from currentRow,
        // returning a new Row with sum.
